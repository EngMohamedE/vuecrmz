...
!function(t) {
  var e = function() {
    ...
    t.getMouseEvent = function(t) {
      var e = [];
      return e.click = "ontouchstart" in window
        ? "touchstart"
        : "click",
      e.mousedown = "ontouchstart" in window
        ? "touchstart"
        : "mousedown",
      e.mouseup = "ontouchstart" in window
        ? "touchend"
        : "mouseup",
      e.mousemove = "ontouchstart" in window
        ? "touchmove"
        : "mousemove",
      e[t]
    },
    ...
    t.setEmojiLib = function(e, n) {
      ...
      o.onload = function() {
        t.emojilib = window[e],
        t.emojilib && t.emojilib.setConfig({img_dir: "https://cdnjs.cloudflare.com/ajax/libs/emojify.js/1.1.0/images/basic/"})
      },
...
!function(t) {
  var e = function() {
    function t(t) {
      if (this.eventTarget = t.eventTarget, this.cfReference = t.cfReference, t.customTemplate && (this.customTemplate = t.customTemplate), !this.eventTarget)
...
!function(t) {
  ...
  var e = function(e) {
    ...
    Object.defineProperty(n.prototype, "value", {
      get: function() {
        ...
        if (n && !this.partOfSeveralChoices) {
          e = (n
            ? "<img src='" + this.referenceTag.domElement.getAttribute("cf-image") + "'/>"
    ...
    Object.defineProperty(n.prototype, "visible", {
      ...
      set: function(t) {
        t
          ...
          : (this.el.classList.add("hide"), this.tabIndex = -1, this.highlight = !1)
      },
      enumerable: !0,
      configurable: !0
    }),
    ...
    n.prototype.onFocus = function(e) {
      ...
      this.eventTarget.dispatchEvent(new CustomEvent(t.ControlElementEvents.ON_FOCUS, {detail: this.positionVector}))
    },
    ...
    n.prototype.onChoose = function() {
      ...
      this.eventTarget.dispatchEvent(new CustomEvent(t.ControlElementEvents.SUBMIT_VALUE, {detail: this}))
    },
...
!function(t) {
  ...
  var e = function() {
    function e(e) {
      ...
      this.listScrollController = new t.ScrollController({interactionListener: this.el, listToScroll: this.list, eventTarget: this.eventTarget, listNavButtons: this.el.getElementsByTagName("cf-list-button")})
    }
    ...
    e.prototype.onElementFocus = function(t) {
      var e = t.detail,
        n = e.x + e.width < this.elementWidth
          ? 0
          : e.x - e.width;
      n *= -1,
    ...
    e.prototype.onChatReponsesUpdated = function(t) {
      ...
      t.detail.currentResponse.isRobotResponse || (this.animateInFromReponseTimer = setTimeout(function() {
        e.animateElementsIn()
        ...
        if (n.inputFieldActive && !o) {
          ...
          n.keyCode == t.Dictionary.keyCodes.left
            ...
            : n.keyCode == t.Dictionary.keyCodes.right
              ? this.columnIndex ++: n.keyCode == t.Dictionary.keyCodes.down
                ? this.updateRowIndex(1)
                : n.keyCode == t.Dictionary.keyCodes.up
                  ? this.updateRowIndex(-1)
                  : n.keyCode != t.Dictionary.keyCodes.enter && n.keyCode != t.Dictionary.keyCodes.space || (this.tableableRows[this.rowIndex] && this.tableableRows[this.rowIndex][this.columnIndex]
                    ? this.tableableRows[this.rowIndex][this.columnIndex].el.click()
                    : this.tableableRows[0] && 1 == this.tableableRows[0].length && this.tableableRows[0][0].el.click()),
          this.validateRowColIndexes() || i.setFocusOnInput()
      }
      i.active || !this.validateRowColIndexes() || !this.tableableRows || 0 != this.rowIndex && 1 != this.rowIndex
    ...
    e.prototype.validateRowColIndexes = function() {
      ...
      return -1 != this.rowIndex && this.tableableRows[this.rowIndex]
        ? (this.columnIndex < 0 && (this.columnIndex = this.tableableRows[this.rowIndex].length - 1), this.columnIndex > this.tableableRows[this.rowIndex].length - 1 && (this.columnIndex = 0), !0)
        : (this.resetTabList(), !1)
    },
    e.prototype.updateRowIndex = function(t) {
      var e = this.rowIndex;
      if (this.rowIndex += t, this.tableableRows[this.rowIndex])
        for (var n = this.tableableRows[e]
    ...
    e.prototype.filterElementsFrom = function(e) {
      ...
      if (i.length > 1) {
        ...
        this.infoElement.innerHTML = 0 == o.length
          ? t.Dictionary.get("input-no-filter").split("{input-value}").join(e)
          : "",
        0 == o.length
    ...
    e.prototype.getElements = function() {
      return this.elements && this.elements.length > 0 && "OptionsList" == this.elements[0].type
    ...
    e.prototype.buildTabableRows = function() {
      ...
      if (this.el.classList.contains("two-row")) {
        ...
        for (var e = 0; e < t.length; e++) {
          var n = t[e];
          n.visible && (n.positionVector.y < 30
    ...
    e.prototype.focusFrom = function(t) {
      this.tableableRows && (this.columnIndex = 0, "bottom" == t
        ? this.rowIndex = this.el.classList.contains("two-row")
          ? 1
          : 0
        : "top" == t && (this.rowIndex = 0), this.tableableRows[this.rowIndex] && this.tableableRows[this.rowIndex][this.columnIndex]
        ? (this.ignoreKeyboardInput = !0, this.tableableRows[this.rowIndex][this.columnIndex].focus = !0)
        : this.resetTabList())
    },
        ...
        switch (this.elements[0].type) {
          case "CheckboxButton":
            ...
            for (var o = 0; o < this.elements.length; o++) {
              ...
              s.checked && (n > 1 && (s.partOfSeveralChoices = !0), i.push(s.value)),
    ...
    e.prototype.buildTags = function(e) {
      ...
      for (var i = 0; i < e.length; i++) {
        ...
        switch (o.type) {
          case "radio":
            this.elements.push(new t.RadioButton({referenceTag: o, eventTarget: this.eventTarget}));
            break;
          case "checkbox":
            this.elements.push(new t.CheckboxButton({referenceTag: o, eventTarget: this.eventTarget}));
            break;
          case "select":
            this.elements.push(new t.OptionsList({referenceTag: o, context: this.list, eventTarget: this.eventTarget}));
            break;
          case "input":
          default:
            "file" == o.type && this.elements.push(new t.UploadFileUI({referenceTag: o, eventTarget: this.eventTarget}))
        }
      ...
      new Promise(function(t, e) {
        ...
        n.eventTarget.dispatchEvent(new CustomEvent(t.UserInputEvents.CONTROL_ELEMENTS_ADDED, {detail: i}))
      })
    },
    ...
    e.prototype.resize = function(e, n) {
      ...
      if (i && i.length > 0) {
        for (var o = [], s = [], r = !1, a = 0; a < i.length; a++) {
          var l = i[a];
          l.visible && (l.calcPosition(), this.listWidth += l.positionVector.width, o.push(l.positionVector.x + l.positionVector.width), s.push(l)),
          l.hasImage() && (r = !0)
        }
        var c = this.el.offsetWidth,
          h = this.listWidth > c;
        h && !r
          ? (this.el.classList.add("two-row"), this.listWidth = Math.max(c, Math.round(o[Math.floor(o.length / 2)] + 50)), this.list.style.width = this.listWidth + "px")
...
!function(t) {
  var e = function() {
    ...
    e.prototype.render = function() {
      ...
      i < 0 && (this.prevButton.classList.contains("active") || this.prevButton.classList.add("active"), this.prevButton.classList.contains("cf-gradient") || this.prevButton.classList.add("cf-gradient")),
      0 == i && (this.prevButton.classList.contains("active") && this.prevButton.classList.remove("active"), this.prevButton.classList.contains("cf-gradient") && this.prevButton.classList.remove("cf-gradient")),
      i > this.max && (this.nextButton.classList.contains("active") || this.nextButton.classList.add("active"), this.nextButton.classList.contains("cf-gradient") || this.nextButton.classList.add("cf-gradient")),
      i <= this.max && (this.nextButton.classList.contains("active") && this.nextButton.classList.remove("active"), this.nextButton.classList.contains("cf-gradient") && this.nextButton.classList.remove("cf-gradient"));
      var o = this.x;
    ...
    e.prototype.setScroll = function(t, e) {
      this.xTarget = this.visibleAreaWidth == this.listWidth
        ? 0
        : t,
      this.render()
    },
...
!function(t) {
  var e = function() {
    ...
    e.prototype.validateAndSetNewData = function(t, e) {
      for (var n in e)
        t[n] || (console.warn("Conversational Form Dictionary warning, '" + n + "' value is undefined, mapping '" + n + "' to default value. See Dictionary.ts for keys."), t[n] = e[n]);
      return t
    },
    e
  }();
...
!function(cf) {
  ...
  var Tag = function() {
    ...
    Object.defineProperty(Tag.prototype, "errorMessage", {
      get: function() {
        return this.errorMessages || (this.domElement.getAttribute("cf-error")
          ? this.errorMessages = cf.Helpers.getValuesOfBars(this.domElement.getAttribute("cf-error"))
          : this.domElement.parentNode && this.domElement.parentNode.getAttribute("cf-error")
          ...
          : "textarea" == t.tagName.toLowerCase()
            ...
            : "select" == t.tagName.toLowerCase()
              ...
              : "button" == t.tagName.toLowerCase()
                ...
                : "option" == t.tagName.toLowerCase() && (e = new cf.OptionTag({domElement: t})),
        e
      }
      return null
    },
    ...
    Tag.prototype.hasConditionsFor = function(t) {
      ...
      for (var e = 0; e < this.conditionalTags.length; e++) {
        if ("cf-conditional-" + t === this.conditionalTags[e].key)
          return !0
      }
      return !1
    },
    ...
    Tag.prototype.findAndSetQuestions = function() {
      if (!this.questions) {
        if (this.domElement.getAttribute("cf-questions"))
          ...
          this.questions = cf.Helpers.getValuesOfBars(t.getAttribute("cf-questions")),
    ...
    Tag.prototype.findAndSetLabel = function() {
      if (this.domElement.getAttribute("cf-label"))
        ...
        var t = this.domElement.parentNode;
        if (t) {
          var e = "label" == t.tagName.toLowerCase()
            ? [t]
        ...
        case "radio":
          ...
          if (t.controlElements)
            for (var s = 0; s < t.controlElements.length; s++) {
              ...
              o.push(r),
              a == r.referenceTag && (r.checked && (this._values.push(a.value), this._activeElements.push(a)), !i && r.checked && (i = !0))
            } else
              for (var s = 0; s < this.elements.length; s++) {
                var a = this.elements[s],
                  l = a.value.toString().toLowerCase(),
                  c = t.text.toString().toLowerCase();
                -1 === l.indexOf(c) && -1 === c.indexOf(l) || (this._activeElements.push(a), this._values.push(a.value), a.domElement.checked = !0, i = !0)
              }
            e = i;
          break;
        case "checkbox":
          if (e = !0, t.controlElements)
            for (var s = 0; s < t.controlElements.length; s++) {
              ...
              r.checked && (this._values.push(a.value), this._activeElements.push(a))
            }
        ...
        for (var i = 0; i < this.optionTags.length; i++)
          ...
          for (var a = !1, i = 0; i < this.optionTags.length; i++) {
            var o = this.optionTags[i],
              ...
              c = t.text.toString().toLowerCase();
            -1 === l.indexOf(c) && -1 === c.indexOf(l) || (this._values.push(o.value), o.domElement.checked = !0, a = !0)
          }
        e = a
      }
      if (!e && 1 == n.length) {
...
!function(t) {
  var e = function(e) {
    ...
    n.prototype.dealloc = function() {
      ...
      this.imageLoadedCallback && (this.imgEl.removeEventListener("load", this.imageLoadedCallback, !1), this.imageLoadedCallback = null),
...
!function(t) {
  var e = function(t) {
    ...
    Object.defineProperty(e.prototype, "checked", {
      ...
      set: function(t) {
        t
          ? (this.el.setAttribute("checked", "checked"), this.referenceTag.domElement.setAttribute("checked", "checked"), this.referenceTag.domElement.checked = !0)
          : (this.el.removeAttribute("checked"), this.referenceTag.domElement.removeAttribute("checked"), this.referenceTag.domElement.checked = !1)
      },
      enumerable: !0,
      configurable: !0
    }),
    ...
    e.prototype.getTemplate = function() {
      return '<cf-radio-button class="cf-button" ' + (this.referenceTag.domElement.checked || this.referenceTag.domElement.hasAttribute("checked")
        ? "checked=checked"
        : "") + ">\n\t\t\t\t<div>\n\t\t\t\t\t<cf-radio></cf-radio>\n\t\t\t\t\t" + this.referenceTag.label + "\n\t\t\t\t</div>\n\t\t\t</cf-radio-button>\n\t\t\t"
    },
    e
...
!function(t) {
  var e = function(t) {
    ...
    e.prototype.getTemplate = function() {
      ...
      return '<cf-button class="cf-button cf-checkbox-button ' + (0 == this.referenceTag.label.trim().length
        ? "no-text"
        : "") + '" checked=' + (t
        ? "checked"
...
!function(t) {
  ...
  var e = function(e) {
    ...
    n.prototype.onClick = function(e) {
      ...
      this.eventTarget.dispatchEvent(new CustomEvent(t.OptionButtonEvents.CLICK, {detail: this}))
    },
    n.prototype.getTemplate = function() {
      var t = '<cf-button class="cf-button ' + (this.isMultiChoice
        ? "cf-checkbox-button"
        : "") + '" ' + (this.referenceTag.domElement.selected
        ? "selected='selected'"
        : "") + ">";
      return t += "<div>",
  ...
  var e = function() {
    ...
    e.prototype.onOptionButtonClick = function(e) {
      if (this.multiChoice)
        ...
        t.ConversationalForm.illustrateFlow(this, "dispatch", t.ControlElementEvents.SUBMIT_VALUE, this.referenceTag),
        this.eventTarget.dispatchEvent(new CustomEvent(t.ControlElementEvents.SUBMIT_VALUE, {detail: e.detail}))
      }
    },
    e.prototype.createElements = function() {
      ...
      for (var e = this.referenceTag.optionTags, n = 0; n < e.length; n++) {
        var i = e[n],
          o = new t.OptionButton({referenceTag: i, isMultiChoice: this.referenceTag.multipleChoice, eventTarget: this.eventTarget});
        this.elements.push(o),
        this.context.appendChild(o.el)
      }
    },
    e.prototype.dealloc = function() {
      for (this.eventTarget.removeEventListener(t.OptionButtonEvents.CLICK, this.onOptionButtonClickCallback, !1), this.onOptionButtonClickCallback = null; this.elements.length > 0;)
        this.elements.pop().dealloc();
      this.elements = null
    },
    e
...
!function(t) {
  var e = function(e) {
    function n(n) {
      var i = e.call(this, n) || this;
      if (i.maxFileSize = 1e11, i.loading = !1, i.submitTimer = 0, i._fileName = "", i._readerResult = "", !t.Helpers.caniuse.fileReader())
    ...
    n.prototype.onDomElementChange = function(e) {
      ...
      i.onloadstart = function(e) {
        ...
        if (s > n.maxFileSize) {
          ...
          n.eventTarget.dispatchEvent(new CustomEvent(t.FlowEvents.USER_INPUT_INVALID, {detail: r}))
        } else {
          n._fileName = o.name,
          n.loading = !0,
          n.animateIn();
          ...
          var c = 1 * Number((s / Math.pow(1024, a)).toFixed(2)) + " " + l[a],
            h = o.name + " (" + c + ")";
          n.el.getElementsByTagName("cf-upload-file-text")[0].innerHTML = h,
          n.eventTarget.dispatchEvent(new CustomEvent(t.ControlElementEvents.PROGRESS_CHANGE, {detail: t.ControlElementProgressStates.BUSY}))
        }
      },
      i.onload = function(e) {
        ...
        n.submitTimer = setTimeout(function() {
          ...
          n.onChoose(),
          n.eventTarget.dispatchEvent(new CustomEvent(t.ControlElementEvents.PROGRESS_CHANGE, {detail: t.ControlElementProgressStates.READY}))
        }, 0)
      },
    ...
    n.prototype.dealloc = function() {
      ...
      this.onDomElementChangeCallback && (this.referenceTag.domElement.removeEventListener("change", this.onDomElementChangeCallback, !1), this.onDomElementChangeCallback = null),
      e.prototype.dealloc.call(this)
    },
    n.prototype.getTemplate = function() {
  ...
  var e = function() {
      ...
      try {
        ...
        navigator.mediaDevices.getUserMedia({
          ...
          t.getAudioTracks().length > 0
            ? (e.hasUserMedia = !0, e.setupEqualizer(), e.microphoneObj.awaitingCallback || e.callInput())
            : e.hasUserMedia = !1
        }).catch(function(n) {
          e.hasUserMedia = !1,
    ...
    e.prototype.callInput = function(e) {
      ...
      this.promise = new Promise(function(t, e) {
        ...
        if (n.promise = null, n.currentTextResponse = e.toString(), !n.currentTextResponse || "" == n.currentTextResponse)
        ...
        n.eventTarget.dispatchEvent(new CustomEvent(t.UserInputEvents.SUBMIT, {detail: i}))
      }).catch(function(e) {
        n.isErrorTerminal(e)
          ? (n.eventTarget.dispatchEvent(new CustomEvent(t.MicrophoneBridgeEvent.TERMNIAL_ERROR, {detail: t.Dictionary.get("microphone-terminal-error")})), console.log("Conversational Form: Terminal error: ", e))
          : (n.inputCurrentError != e && (n.inputErrorCount = 0, n.inputCurrentError = e), n.inputErrorCount++, n.inputErrorCount > 2
            ? n.showError(e)
            : (n.eventTarget.dispatchEvent(new CustomEvent(t.MicrophoneBridgeEvent.TERMNIAL_ERROR, {detail: t.Dictionary.get("microphone-terminal-error")})), console.log("Conversational Form: Terminal error: ", e)))
      })
    },
    ...
    e.prototype.showError = function(e) {
      ...
      this.eventTarget.dispatchEvent(new CustomEvent(t.FlowEvents.USER_INPUT_INVALID, {detail: n})),
      this.callInput()
    },
    e.prototype.setupEqualizer = function() {
      var t = this.el.getElementsByTagName("cf-icon-audio-eq")[0];
      n.supported && t && (this.equalizer = new n({stream: this.currentStream, elementToScale: t}))
    },
    e
  }();
...
!function(t) {
  ...
  var e = function() {
    ...
    return Object.defineProperty(e.prototype, "typing", {
      ...
      set: function(t) {
        t
          ? (this.el.classList.add("typing"), this.loading = !1, this.mic && this.mic.cancel())
          : (this.el.classList.remove("typing"), this.mic && this.mic.callInput())
      },
      enumerable: !0,
      configurable: !0
    }),
    ...
    e.prototype.addMicrophone = function(e) {
      ...
      this.mic = new t.MicrophoneBridge({el: i, button: this, eventTarget: this.eventTarget, microphoneObj: e}),
    ...
    e.prototype.onClick = function(e) {
      this.mic && !this.typing
        ? this.mic.callInput()
        : this.eventTarget.dispatchEvent(new CustomEvent(t.UserInputSubmitButtonEvents.CHANGE))
    },
...
!function(t) {
  var e = function(e) {
    ...
    Object.defineProperty(n.prototype, "visible", {
      set: function(t) {
        ...
        !this.el.classList.contains("animate-in") && t
          ...
          : this.el.classList.contains("animate-in") && !t && this.el.classList.remove("animate-in")
      },
      enumerable: !0,
      configurable: !0
    }),
    Object.defineProperty(n.prototype, "disabled", {
      ...
      set: function(t) {
        this._disabled != t && (this._disabled = t, t
    ...
    Object.defineProperty(n.prototype, "height", {
      get: function() {
        var e = 0,
          n = 0,
          i = this.el;
        return t.Helpers.isInternetExlorer()
          ? (e = i.offsetHeight, n = parseInt(i.currentStyle.marginTop, 10) + parseInt(i.currentStyle.marginBottom, 10), n *= 2)
          : (e = parseInt(document.defaultView.getComputedStyle(i, "").getPropertyValue("height"), 10), n = parseInt(document.defaultView.getComputedStyle(i, "").getPropertyValue("margin-top")) + parseInt(document.defaultView.getComputedStyle(i, "").getPropertyValue("margin-bottom"))),
        e + n
      },
      enumerable: !0,
      configurable: !0
  ...
  e.hideUserInputOnNoneTextInput = !1,
...
!function(t) {
  var e = function(e) {
    function n(n) {
      ...
      i.submitButton = new t.UserInputSubmitButton({eventTarget: i.eventTarget}),
      i.el.appendChild(i.submitButton.el),
      n.microphoneInputObj && (i.microphoneObj = n.microphoneInputObj, i.microphoneObj && i.microphoneObj.init && i.microphoneObj.init(), i.submitButton.addMicrophone(i.microphoneObj)),
      i
    }
    return __extends(n, e),
    ...
    Object.defineProperty(n.prototype, "disabled", {
      set: function(t) {
        ...
        console.log("option hasChanged", t),
        e && (this._disabled = t, t
          ? (this.el.setAttribute("disabled", "disabled"), this.inputElement.blur())
          : (this.setFocusOnInput(), this.el.removeAttribute("disabled")))
      },
      enumerable: !0,
      configurable: !0
    ...
    n.prototype.getFlowDTO = function() {
      var t;
      return t = this.controlElements && this.controlElements.active
    ...
    n.prototype.reactivate = function() {
      ...
      this.microphoneObj && !this.submitButton.typing && (this.submitButton.loading = !0, this.submitButton.typing = !1, this.submitButton.active = !0)
    },
    n.prototype.onFlowStopped = function() {
    ...
    n.prototype.onInputChange = function() {
      if (this.active || this.controlElements.active) {
        ...
        this.inputElement.style.height = (0 === this.inputElement.scrollHeight
          ? e
          : this.inputElement.scrollHeight) + "px",
        t.ConversationalForm.illustrateFlow(this, "dispatch", t.UserInputEvents.HEIGHT_CHANGE),
        this.eventTarget.dispatchEvent(new CustomEvent(t.UserInputEvents.HEIGHT_CHANGE, {detail: this.inputElement.scrollHeight}))
      }
    },
    n.prototype.inputInvalid = function(e) {
      ...
      this.disabled = !0,
      this.inputElement.setAttribute("placeholder", i.errorText || this._currentTag.errorMessage),
    ...
    n.prototype.setPlaceholder = function() {
      this._currentTag
        ? this._currentTag.inputPlaceholder
          ...
          : this.inputElement.setAttribute("placeholder", "group" == this._currentTag.type
            ? t.Dictionary.get("group-placeholder")
            : t.Dictionary.get("input-placeholder"))
        : this.inputElement.setAttribute("placeholder", t.Dictionary.get("group-placeholder"))
    },
    n.prototype.checkForCorrectInputTag = function() {
      ...
      if (this.inputElement && (e || n) && (this.inputElement.removeEventListener("focus", this.onInputFocusCallback, !1), this.inputElement.removeEventListener("blur", this.onInputBlurCallback, !1)), e || i) {
        ...
        this.inputElement = o,
        "number" !== this._currentTag.type && "email" !== this._currentTag.type || (this.inputElement.type = this._currentTag.type, o.setAttribute("type", this._currentTag.type))
      } else if (n) {
      ...
      this.inputElement && (e || n) && (this.inputElement.addEventListener("focus", this.onInputFocusCallback, !1), this.inputElement.addEventListener("blur", this.onInputBlurCallback, !1)),
    ...
    n.prototype.onFlowUpdate = function(n) {
      ...
      this.inputElement.setAttribute("type", o
      ...
      t.UserInputElement.hideUserInputOnNoneTextInput && (this.controlElements.active
        ? (this.el.classList.add("hide-input"), this.controlElements.focusFrom("bottom"))
        ...
        if (!this.el.hasAttribute("disabled")) {
          ...
          if (e.keyCode == t.Dictionary.keyCodes.enter && !e.shiftKey || e.keyCode == t.Dictionary.keyCodes.space)
            if (e.keyCode == t.Dictionary.keyCodes.enter && this.active)
              ...
              e.preventDefault();
              var s = "group" == this._currentTag.type
                ? this._currentTag.getGroupTagType()
                : this._currentTag.type;
              if ("select" == s || "checkbox" == s) {
                var r = this._currentTag;
                "checkbox" == s || r.multipleChoice
                  ? (this.active || this.isControlElementsActiveAndUserInputHidden()) && e.keyCode == t.Dictionary.keyCodes.enter
                    ? this.submitButton.click()
                    : (this.active || this.controlElements.active || this.isControlElementsActiveAndUserInputHidden() || (this.resetValue(), this.setFocusOnInput()), this.dispatchKeyChange(o, e.keyCode))
    ...
    n.prototype.doSubmit = function() {
      ...
      this.eventTarget.dispatchEvent(new CustomEvent(t.UserInputEvents.SUBMIT, {detail: e}))
    },
...
!function(t) {
  ...
  var e = function(e) {
    ...
    n.prototype.setValue = function(e) {
      ...
      if (e) {
        if (this.response = this.originalResponse = e.text, this.processResponseAndSetText(), this.responseLink && !this.isRobotResponse && this.responseLink.processResponseAndSetText(), e && e.controlElements && e.controlElements[0])
    ...
    n.prototype.processResponseAndSetText = function() {
      ...
      if (this.originalResponse) {
        ...
        if (-1 != i.indexOf("contains-image") && this.textEl.classList.add("contains-image"), this.isRobotResponse) {
          ...
          for (var h = i.split("&&"), u = this, p = 0; p < h.length; p++)
            !function(t) {
              var n = h[t];
              setTimeout(function() {
                e.tryClearThinking(),
                e.textEl.innerHTML += "<p>" + n + "</p>";
                var t = e.textEl.getElementsByTagName("p");
                t[t.length - 1].offsetWidth,
                t[t.length - 1].classList.add("show"),
                e.scrollTo()
              }, c + (t + 1) * u.uiOptions.robot.chainedResponseTime)
            }
          (p);
          this.readyTimer = setTimeout(function() {
            e.onReadyCallback && e.onReadyCallback(),
            e.onReadyCallback = null
          }, c + h.length * this.uiOptions.robot.chainedResponseTime)
        } else {
          this.tryClearThinking(),
          this.textEl.innerHTML = "<p>" + i + "</p>";
          var d = this.textEl.getElementsByTagName("p");
          d[d.length - 1].offsetWidth,
          d[d.length - 1].classList.add("show"),
          this.scrollTo()
        }
        this.parsedResponse = i,
        this.addSelf(),
        this.textEl.removeAttribute("value-added"),
        setTimeout(function() {
          e.textEl.setAttribute("value-added", ""),
          e.el.classList.add("peak-thumb")
        }, 0),
        this.checkForEditMode(),
        this.response = i.split("&&").join(" ")
      }
    },
    ...
    n.prototype.setToThinking = function() {
      (this.isRobotResponse && 0 !== this.uiOptions.robot.robotResponseTime || !this.isRobotResponse && this.cfReference.uiOptions.user.showThinking) && (this.textEl.innerHTML = n.THINKING_MARKUP, this.el.classList.remove("can-edit"), this.el.setAttribute("thinking", "")),
    ...
    n.prototype.onClick = function(e) {
      ...
      this.eventTarget.dispatchEvent(new CustomEvent(t.ChatResponseEvents.USER_ANSWER_CLICKED, {detail: this._tag}))
    },
    n.prototype.setData = function(t) {
      this.image = t.image,
    ...
    n.prototype.onElementCreated = function() {
      ...
      this.isRobotResponse || null != this.response
        ...
        : this.cfReference.uiOptions.user.showThumb && this.el.classList.add("peak-thumb")
    },
    n.prototype.dealloc = function() {
      ...
      this.onClickCallback && (this.el.removeEventListener(t.Helpers.getMouseEvent("click"), this.onClickCallback, !1), this.onClickCallback = null),
      e.prototype.dealloc.call(this)
    },
    n.prototype.getTemplate = function() {
      return '<cf-chat-response class="' + (this.isRobotResponse
        ? "robot"
        : "user") + '">\n\t\t\t\t<thumb></thumb>\n\t\t\t\t<text></text>\n\t\t\t</cf-chat-response>'
    },
    n
  }(t.BasicElement);
  e.THINKING_MARKUP = "<p class='show'><thinking><span>.</span><span>.</span><span>.</span></thinking></p>",
  t.ChatResponse = e
}(cf || (cf = {}));
var __extends = this && this.__extends || function() {
    var t = Object.setPrototypeOf || {
...
!function(t) {
  ...
  var e = function(e) {
    ...
    n.prototype.onUserWantsToEditTag = function(t) {
      ...
      e && (this.responses.length > 2 && (this.responses[this.responses.length - 1].isRobotResponse || this.responses.pop().dealloc(), this.responses.pop().dealloc()), this.currentUserResponse = e, this.currentResponse = this.responses[this.responses.length - 1], this.onListUpdate(this.currentUserResponse))
    },
    n.prototype.onListUpdate = function(e) {
      var n = this;
      clearTimeout(this.updateTimer),
      this.updateTimer = setTimeout(function() {
        n.eventTarget.dispatchEvent(new CustomEvent(t.ChatListEvents.CHATLIST_UPDATED, {detail: n})),
        e.show()
      }, 0)
    },
    ...
    n.prototype.setCurrentUserResponse = function(e) {
      ...
      !this.flowDTOFromUserInputUpdate.text && e.tag && ("group" == e.tag.type
        ? this.flowDTOFromUserInputUpdate.text = t.Dictionary.get("user-reponse-missing-group")
        : "password" != e.tag.type && (this.flowDTOFromUserInputUpdate.text = t.Dictionary.get("user-reponse-missing"))),
    ...
    n.prototype.updateThumbnail = function(e, n) {
      ...
      for (var i = e
        ...
        : t.Dictionary.get("user-image"), o = 0; o < this.responses.length; o++) {
  ...
  var e = function() {
    ...
    e.prototype.userInputSubmit = function(e) {
      ...
      var o = this.currentTag.setTagValueAndIsValid(i),
        ...
        r = !1,
        a = function() {
          return n.currentTag.validationCallback && "function" == typeof n.currentTag.validationCallback && !s && o
            ? (s = !0, void n.currentTag.validationCallback(i, function() {
              o = !0,
              a()
            }, function(t) {
              o = !1,
            ...
            : n.flowStepCallback && "function" == typeof n.flowStepCallback && !r && o
              ? (r = !0, void n.flowStepCallback(i, function() {
                o = !0,
                a()
              }, function(t) {
                o = !1,
              ...
              : void(o
                ? (t.ConversationalForm.illustrateFlow(n, "dispatch", t.FlowEvents.USER_INPUT_UPDATE, i), i.input && (i = i.input.getFlowDTO()), n.eventTarget.dispatchEvent(new CustomEvent(t.FlowEvents.USER_INPUT_UPDATE, {detail: i})), setTimeout(function() {
                  return n.nextStep()
                }, t.ConversationalForm.animationsEnabled
                  ? 250
                  : 0))
                : (t.ConversationalForm.illustrateFlow(n, "dispatch", t.FlowEvents.USER_INPUT_INVALID, i), n.eventTarget.dispatchEvent(new CustomEvent(t.FlowEvents.USER_INPUT_INVALID, {detail: i}))))
        };
      a()
    },
    e.prototype.startFrom = function(t, e) {
      void 0 === e && (e = !1),
      this.step = "number" == typeof t
        ? t
        : this.tags.indexOf(t),
        ...
        if (s !== e)
          for (var r = 0; r < n.length; r++) {
            ...
            if ("cf-conditional-" + s.name === a.key) {
              ...
              if (c && (this.activeConditions[s.id || s.name] = n, ++i == n.length))
                return !0
            }
          }
        }
    ...
    e.prototype.validateStepAndUpdate = function() {
      this.maxSteps > 0 && (this.step == this.maxSteps
        ? this.cfReference.doSubmitForm()
        : (this.step %= this.maxSteps, this.currentTag.disabled
          ? this.skipStep()
          : this.showStep()))
    },
...
!function(cf_1) {
  var ConversationalForm = function() {
    function ConversationalForm(options) {
      ...
      !0 === options.hideUserInputOnNoneTextInput && (cf_1.UserInputElement.hideUserInputOnNoneTextInput = !0),
      ...
      (options.preventAutoFocus || "" == this.formEl.getAttribute("cf-prevent-autofocus")) && (cf_1.UserInputElement.preventAutoFocus = !0),
      this.dictionary = new cf_1.Dictionary({data: options.dictionaryData, robotData: options.dictionaryRobot, userImage: options.userImage, robotImage: options.robotImage}),
      this.context = options.context
        ? options.context
        : document.body,
      this.tags = options.tags,
      options.microphoneInput && (options.microphoneInput.init && options.microphoneInput.input || (console.warn("Conversational Form: microphoneInput is not correctly setup", options.microphoneInput), options.microphoneInput = null)),
      ...
      if (Object.keys(e).length > 0)
        for (var o in e)
          if (e[o].length > 0) {
            ...
            for (var r = new cf_1.TagGroup({fieldset: s, elements: e[o]}), n = 0; n < e[o].length; n++) {
              var a = e[o][n];
              0 == n
    ...
    ConversationalForm.prototype.setupUI = function() {
      this.flowManager = new cf_1.FlowManager({cfReference: this, flowStepCallback: this.flowStepCallback, eventTarget: this.eventTarget, tags: this.tags}),
      ...
      this.chatList = new cf_1.ChatList({eventTarget: this.eventTarget, cfReference: this}),
      t.appendChild(this.chatList.el),
      this.userInput = new cf_1.UserTextInput({microphoneInputObj: this.microphoneInputObj, eventTarget: this.eventTarget, cfReference: this}),
    ...
    ConversationalForm.prototype.addTags = function(t, e, n) {
        ...
        if ("fieldset" === s.tag)
          for (var r = cf_1.TagsParser.parseGroupTag(s), a = 0; a < r.children.length; a++) {
            ...
            if (cf_1.Tag.isTagValid(l)) {
              ...
              c.name || (c.name = "tag-ref-" + a.toString()),
              i.push(c)
            }
          }
        else {
      ...
      this.tags = this.flowManager.addTags(i, e
        ? this.flowManager.getStep() + 1
        : n)
    },
    ...
    ConversationalForm.prototype.doSubmitForm = function() {
      if (this.el.classList.add("done"), this.userInput.reset(), this.submitCallback)
    ...
    ConversationalForm.prototype.remove = function() {
      ...
      this.onUserAnswerClickedCallback && (this.eventTarget.removeEventListener(cf_1.ChatResponseEvents.USER_ANSWER_CLICKED, this.onUserAnswerClickedCallback, !1), this.onUserAnswerClickedCallback = null),
    ...
    ConversationalForm.illustrateFlow = function(t, e, n, i) {
      if (void 0 === i && (i = null), ConversationalForm.illustrateAppFlow) {
        var o = "font-weight: 900; background: " + ("receive" == e
          ? "#e6f3fe"
          : "pink") + "; color: black; padding: 0px 5px;";
        console.log("%c** event flow: %c" + n + "%c flow type: %c" + e + "%c from: %c" + t.constructor.name, "font-weight: 900;", o, "font-weight: 400;", o, "font-weight: 400;", o),
      ...
      if (!cf.ConversationalForm.hasAutoInstantiated) {
        ...
        if (t && t.length > 0) {
          for (var n = 0; n < t.length; n++) {
            var i = t[n],
              o = e[n];
            cf.ConversationalForm.startTheConversation({formEl: i, context: o})
          }
...
function(t, e) {
  "function" == typeof define && define.amd
    ...
    : "object" == typeof module && module.exports
      ? module.exports = t.conversationalform = e(require("conversational-form"))
